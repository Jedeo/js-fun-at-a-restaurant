...
console.log(`Shou I order more? ${shouldOrderMore}`);
...
var vegetables = ['Arrowroot', 'Artichoke', 'Arugula', 'Asparagus', 'Broccoli'];
...
var fruits = ['Apricots', 'Avocado', 'Banana', 'Blackberries', 'Blackcurrant', 'Blueberries', 'Breadfruit' ];
